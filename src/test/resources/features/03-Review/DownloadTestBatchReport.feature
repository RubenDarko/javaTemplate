@Automation @Review @DownloadTestBatchReport @UserStoryTSS-364 @TSS-2664

Feature: Download Test Batch Report

  User needs to download the Test Batch report as part of the Archive process
  ...
  @TEST_TSS-2282 @Automation
  Scenario: Download PDF Checkbox Selected
    Given The Review Page Is Active
    When User expands the last Batch from the list in the left side
